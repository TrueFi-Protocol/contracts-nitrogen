...
describe('StructuredIndexedPortfolio.calculateWaterfallWithoutFees.multitranche', () => {
  ...
  describe('no assets deposited', () => {
    it('capital formation', async () => {
      ...
      const waterfall = await portfolio.calculateWaterfallWithoutFees()
  ...
  describe('with assets deposited', () => {
    ...
    describe('live', () => {
      ...
      it('investment gained value', async () => {
        ...
        const tranchesValues = await calculateTranchesValuesAfterTime(portfolio, tranchesValuesAfterDeposit, increaseValueTimeElapsed, portfolioValueAfterIncrease)

        expect(await portfolio.calculateWaterfallWithoutFees()).to.deep.eq(tranchesValues)
      })

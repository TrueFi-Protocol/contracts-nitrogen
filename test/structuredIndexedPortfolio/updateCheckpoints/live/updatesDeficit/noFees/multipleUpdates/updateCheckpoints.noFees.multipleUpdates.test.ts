...
describe('StructuredIndexedPortfolio.updateCheckpoints.noFees.multipleUpdates', () => {
  ...
  it('senior empty, junior empty, equity empty', async () => {
    ...
    for (let i = 1; i < updatesNumber; i++) {
      ...
      expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(seniorTranche, [Zero, seniorDeficit])
  ...
  it('senior deficit partially comes back', async () => {
    ...
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(equityTranche, [Zero, Zero])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(juniorTranche, [Zero, juniorDeficit])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(seniorTranche, [seniorRealValue, seniorDeficit])
    expect(equityCheckpoint.deficit).to.eq(Zero)
    expect(juniorCheckpoint.deficit).to.eq(juniorDeficit)
    expect(seniorCheckpoint.deficit).to.eq(seniorDeficit)
  })
  ...
  it('senior deficit comes back', async () => {
    ...
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(equityTranche, [Zero, Zero])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(juniorTranche, [Zero, juniorDeficit])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(seniorTranche, [seniorRealValue, Zero])
    expect(equityCheckpoint.deficit).to.eq(Zero)
    expect(juniorCheckpoint.deficit).to.eq(juniorDeficit)
  ...
  it('junior deficit partially comes back', async () => {
    ...
    const [equityCheckpoint, juniorCheckpoint, seniorCheckpoint] = await getDeficitCheckpoints(portfolio)
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(equityTranche, [Zero, Zero])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(juniorTranche, [juniorRealValue, juniorDeficit])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(seniorTranche, [seniorRealValue, Zero])
    expect(equityCheckpoint.deficit).to.eq(Zero)
    expect(juniorCheckpoint.deficit).to.eq(juniorDeficit)
    expect(seniorCheckpoint.deficit).to.eq(Zero)
  ...
  it('junior deficit comes back', async () => {
    ...
    const [equityCheckpoint, juniorCheckpoint, seniorCheckpoint] = await getDeficitCheckpoints(portfolio)
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(equityTranche, [Zero, Zero])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(juniorTranche, [juniorRealValue, Zero])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(seniorTranche, [seniorRealValue, Zero])
    expect(equityCheckpoint.deficit).to.eq(Zero)
  ...
  it('equity surplus', async () => {
    ...
    const [equityCheckpoint, juniorCheckpoint, seniorCheckpoint] = await getDeficitCheckpoints(portfolio)
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(equityTranche, [equityRealValue, Zero])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(juniorTranche, [juniorRealValue, Zero])
    expect('updateCheckpointFromPortfolio').to.be.calledOnContractWith(seniorTranche, [seniorRealValue, Zero])
    expect(equityCheckpoint.deficit).to.eq(Zero)
    expect(juniorCheckpoint.deficit).to.eq(Zero)
